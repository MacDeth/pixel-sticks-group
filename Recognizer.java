...
// Receives an option from the user that corresponds to the language the user wants to test
...
// Receives a file path from the user and determines whether or not it is valid.
